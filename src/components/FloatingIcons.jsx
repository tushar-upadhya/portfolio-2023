...
const FloatingIcons = () => {
  return (
    <div className="z-[10] flex justify-between w-full items-center my-14">
      <a href="mailto:tusharupadhyay691@gmail.com" className="social">
        <motion.span
        ...
        >
          ...
          >
            <motion.img
              ...
              src={email}
              alt="gmail"
              className="sm:h-8 sm:w-8 h-6 w-6 hover:scale-[1.05] hover:-rotate-12 transition-all duration-300 ease-in-out"
            />
          </motion.span>
        </motion.span>
      </a>
        ...
        >
          ...
          >
            <motion.img
              ...
              src={github}
              alt="github"
              className="sm:h-10 sm:w-10 h-6 w-6 hover:scale-[1.05] hover:-rotate-12 transition-all duration-300 ease-in-out"
            />
          </motion.span>
        </motion.span>
      </a>
        ...
        >
          ...
          >
            <motion.img
              ...
              src={linkedin}
              alt="linkedin"
              className="sm:h-8 sm:w-8 h-5 w-5 hover:scale-[1.05] hover:-rotate-12 transition-all duration-300 ease-in-out"
            />
          </motion.span>
        </motion.span>
      </a>
